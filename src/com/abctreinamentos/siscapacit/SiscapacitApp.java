...
/***************************/
	...
	{
		 int idcurso = Integer.parseInt(JOptionPane.showInputDialog("Informe o ID")); 
		 String nome = JOptionPane.showInputDialog("Digite o nome"); 
	...
	//listarCursos()
	//listarCurso(int cdCurso)
	//alterarCurso(Curso curso) 
	//excluirServidorPublico(int cdCurso)
